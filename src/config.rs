...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
            ...
            map.insert("password".to_string(), "Yek85651220,".to_string());
            RwLock::new(map)
        };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["114.96.88.189"];
pub const RS_PUB_KEY: &str = "ObkmGIorEYnaSwE41C6nvOxvZxksonKh1VkcpN3lHl4=";
